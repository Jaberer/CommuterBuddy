...
namespace PhoneApp6
{
    public partial class App : Application
    {
        ...
        private void CopyToIsolatedStorage()
        {
            ...
            {
                string[] files = new string[] { "Digital.mp3", "Digital2.mp3", "MilitaryAlarm.mp3", "Cookoo.mp3", "TowerChime.mp3",
                    "Exluna.mp3", "Mene.mp3", "Frog.mp3", "String.mp3", "Smooth.mp3", "Synth.mp3", "Synth2.mp3", "ThunderRoll.mp3",  "Victory.mp3" };
        ...
        { 
            ...
            { 
                ...
                IsolatedStorageSettings.ApplicationSettings["started"] = 0;
                started = 0;
            }
        }
